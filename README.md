...
-
Перейдите по ссылке http://194.87.144.198:8001/

И авторизируйтесь с правами наблюдателя по ссылке http://194.87.144.198:8001/users/

Логин и пароль наблюдателя: observer@gmail.com:00000000
...
Для открытия функционала рабочего персонала необходимо перейти по URL http://194.87.144.198:8001/users/, чтобы клиентам не мозолила глаза кнопочка в навигационном баре "Авторизация"
...
- Для Windows (celery -A config worker -l info -P solo)
